    ...
    <div class="container mx-auto p-4 ">
        <form class=" bg-white p-6 rounded shadow-md" action="{{ route('employee.store') }}" method="POST">
            ...
            <div class="mb-4">
                ...
                :value="old('startedOn')" required autofocus/>
            ...
            <div class="mb-4">
                ...
                :value="old('endedOn')" required autofocus/>
            ...
            <div class="mb-4">
                ...
                <x-text-input type="text" id="accomadation" name="accomadation" class="mt-1 block w-full"
                    :value="old('accomadation')" required autofocus/>
            ...
            <div class="mb-4">
                ...
                <x-text-input type="text" id="allowance" name="allowance" class="mt-1 block w-full"
                    :value="old('allowance')" required autofocus/>
            ...
            <div class="mb-4">
                ...
                <x-text-input type="text" id="transportation_expense" name="transportation_expense"
                    class="mt-1 block w-full" :value="old('transportation_expense')" required autofocus/>
            ...
            <div class="mb-4">
                ...
                <x-text-input type="text" id="mobile" name="mobile" class="mt-1 block w-full" :value="old('mobile')"
                    required autofocus/>
            ...
            <div class="mb-4">
                ...
                <x-text-input type="text" id="vehicle" name="vehicle" class="mt-1 block w-full" :value="old('vehicle')"
                    required autofocus/>
            ...
            <div class="mb-4">
                ...
                <x-text-input type="text" id="yearly_ticket" name="yearly_ticket" class="mt-1 block w-full"
                    :value="old('yearly_ticket')" required autofocus/>
            ...
            <div class="mb-4">
                ...
                <x-text-input type="text" id="medical_payment" name="medical_payment" class="mt-1 block w-full"
                    :value="old('medical_payment')" required autofocus/>
            ...
            <div class="mb-4">
                ...
                <x-text-input type="text" id="bonus" name="bonus" class="mt-1 block w-full"
                    :value="old('bonus')" required autofocus/>
            ...
            <div class="mb-4">
                ...
                <x-text-input type="text" id="visa_charge" name="visa_charge" class="mt-1 block w-full"
                    :value="old('visa_charge')" required autofocus/>
            ...
            <div class="mb-4">
                ...
                <x-text-input type="text" id="insurance" name="insurance" class="mt-1 block w-full"
                    :value="old('insurance')" required autofocus/>
